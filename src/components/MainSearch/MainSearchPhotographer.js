            ...
            <div className="row paddin-lr hover-div mb-3">
                <div className="col-lg-12 col-md-12 col-sm-12">
                    <ul className="d-flex p-0">
                        <li class="list_info" onClick={() => handleClickActivePage('venue')}>
                            <VenueIcon />Venue</li>
                        <li class="list_info active" onClick={() => handleClickActivePage('photographer')}><PhotographerIcon />Photographer</li>

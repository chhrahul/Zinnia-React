            ...
            <div className="row mb-3">
                <div className="col-lg-12 col-md-12 col-sm-12 venue-top">
                    <ul className="d-flex p-0">
                        <li class={resultType === 'map' ? 'list_info active' : 'list_info'} onClick={() => handleClickActiveTab('map')}><svg xmlns="http://www.w3.org/2000/svg" width="15" height="20" viewBox="0 0 15 20" fill="none">
                        ...
                        <li class={resultType === 'list' ? 'list_info active' : 'list_info'} onClick={() => handleClickActiveTab('list')}><svg xmlns="http://www.w3.org/2000/svg" width="19" height="10" viewBox="0 0 19 10" fill="none">

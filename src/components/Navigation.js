    ...
    return (
        < >
            <div className="container-fluid main-nav position-relative" style={{ 'paddingRight': 0, 'paddingLeft': 0 }} >
                <div className="row">
                    <Navbar expand="md">
                        <Container fluid className='mx-md-5 p-md-0'>
                            ...
                            <Navbar.Collapse id="navbarScroll" >
                                ...
                                >
                                    ...
                                    <Nav.Link href="#action1" onClick={() => handleClickNav('calender')} className={activeNav === 'calender' || splitLocation[1] === "calender" ? 'text-cyan-color' : ""}><span className='d-none d-lg-inline '>/</span> Calender </Nav.Link>
                                    <Nav.Link href="#action1" onClick={() => handleClickNav('invoices')} className={activeNav === 'invoices' || splitLocation[1] === "invoices" ? 'text-cyan-color' : ""}><span className='d-none d-lg-inline '>/</span> Invoices </Nav.Link>
                                    <Nav.Link href="#action1" onClick={() => handleClickNav('messages')} className={activeNav === 'messages' || splitLocation[1] === "messages" ? 'text-cyan-color' : ""}><span className='d-none d-lg-inline '>/</span> Messages </Nav.Link>

                        ...
                        <div className="col-lg-3 col-md-4 col-sm-12">
                            <div class="card couple-card-custom">
                                ...
                                <div class="card-body">
                                    ...
                                    <p className="mb-0 venue-address-custom text-black-50">$6,000.00</p>
                                    <p className="mb-0 venue-address-custom text-black-50"><img src="/images/icons/star.svg" alt="star" />4.8</p>
                                    <button type="button" class="btn btn-outline-secondary fs-6">Message Vendor</button>
                                    <div>
...
const CancelModal = (props) => {
    ...
    return (
        <>
            <Button variant="btn text-danger p-0 cancel-danger-btn" onClick={handleShow}>
                {title}
            </Button>

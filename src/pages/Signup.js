...
function Signup() {
    ...
    const gettingMarriedThirdStepProps = {
        handleInputGettingMarried,
        gettingMarriedSignupDetails,
        selectedSignupType,
        handleSelectSignupType
    ...
    // for vender sighn-up
    const gettingVenderFisrtStepProps = {
        handleInputGettingVender,
        gettingVenderSignupDetails,
        selectedSignupType,
        handleSelectSignupType
    }
    const gettingVenderSecondStepProps = {
        handleInputGettingVender,
        gettingVenderSignupDetails,
        selectedSignupType,
        handleSelectSignupType
    ...
    const gettingVenderThirdStepProps = {
        handleInputGettingVender,
        gettingVenderSignupDetails,
        selectedSignupType,
        handleSelectSignupType
                            ...
                            <div className="container- position-absolute- h-100-">
                                <div className='row px-md-5 mt-5'>
                                    ...
                                    {selectedSignupType === 'gettingMarried' ?
                                        <>
                                            {step === 2 && <SignupFirstStep {...gettingMarriedFisrtStepProps} />}
                                            {step === 3 && <SignupSecondStep {...gettingMarriedSecondStepProps} />}
                                            {step === 4 && <SignupThirdStep  {...gettingMarriedThirdStepProps} />}
                                            {step === 5 && <SignupFourthStep />}
                                        </>
                                        :
                                        <>
                                            {step === 2 && <VenderSignupFirstStep {...gettingVenderFisrtStepProps} />}
                                            {step === 3 && <VenderSignupSecondStep {...gettingVenderSecondStepProps} />}
                                            {step === 4 && <VenderSignupThirdStep  {...gettingVenderThirdStepProps} />}
                                            {step === 5 && <VenderSignupFourthStep />}
                                            {step === 6 && 'test'}
                                        </>
                                    }
                                </div>
...
function NextButton(props) {
    ...
    return (
        <button type="button" className="btn btn-secondary navigate-btn" disabled={selectedSignupType !== '' ? false : true} id="next-btn" onClick={handleClickNext}>
            Next
        </button>
    )
}

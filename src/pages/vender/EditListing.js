...
import { VenderSignupFourthStep, VenderSignupSecondStep } from '../../components/GettingVenderSignup';
                ...
                <div className="container-fluid" style={{ 'paddingRight': 0, 'paddingLeft': 0 }}>
                    <div className='row'>
                        ...
                        <div className='col-md-12 order-md-0 order-1 position-relative- p-0-' >
                            <div className=" position-absolute- h-100-">
                                <div className='row px-md-5'>
                                    <VenderSignupFourthStep {...gettingVenderProps} type={'edit'} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='col-md-6 order-md-0 order-1 position-relative- p-0-' >
                            <div className=" position-absolute- h-100-">
                                <div className='row px-md-5 '>
                                    <VenderSignupSecondStep {...gettingVenderProps} type={'edit'} />
                                </div>
                            </div>
                        </div>
                    </div>

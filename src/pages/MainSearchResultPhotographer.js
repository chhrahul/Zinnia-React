            ...
            <div className="row paddin-lr hover-div mb-3">
                <div className="col-lg-12 col-md-12 col-sm-12 venue-top">
                    <ul className="d-flex p-0">
                        <li class="list_info"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="24" viewBox="0 0 26 24" fill="none" style={{ 'marginRight': 5, 'width': 20, 'height': 20 }}>
                        ...
                        <li class="list_info active"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" fill="none" style={{ 'marginRight': 5, 'width': 20, 'height': 20 }}>

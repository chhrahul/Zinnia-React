            ...
            <div className="container-fluid px-md-5  mt-3 custom-search">
                <div className="row paddin-lr">
                    <div className="col-lg-6 col-md-6 col-sm-12 ">
                        <h4 className="mt-4 text-black fw-bolder">Save the date! </h4>
                        ...
                        You will receive a confirmation email and your payment will be <br></br> processed once your vendor(s) have confirmed your booking.<br></br> Confirmation emails will be sent within 48 hours of initial booking.
                        </p>

                        <div className="row paddin-lr p-0 custom-right-content">
                            <button type="button" class="btn btn-secondary btn-lg mt-2  account-button">Go to my account</button>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-12 ">
